  ...
  <div class="col-md-6">
    <div class="row">
      <div class="col-md-12 mb-2">
        ...
        <?= Html::textInput('param[fir-tit]', $firTit, ['class' => 'form-control'])?>
      </div>
      <div class="col-md-12 mb-2">
      <label>Второй заголовок</label>
      
        <?= Html::textInput('param[step-tit]', $stepTit, ['class' => 'form-control'])?>
      </div>
      <div class="col-md-12 mb-2">
      ...
      <div class="col-md-12 mb-2">
        ...
        <?= Html::textInput('param[text]', $text, ['class' => 'form-control', 'placeholder' => 'Текст']) ?>
      </div>
      <div class="col-md-12 mb-2">
        <label>Текст кнопки</label>
        <?= Html::textInput('param[button]', $button, ['class' => 'form-control', 'placeholder' => 'Текст']) ?>
      </div>
      <div class="col-md-12 mb-2">
        <label>Наименование</label>
        <?= Html::textInput('param[name]', $nameVal, ['class' => 'form-control', 'placeholder' => 'Текст']) ?>
      </div>
    </div>
      <!-- 'link2'
      'link1' -->
